...
def enhance_response(response, confidence):
    """Enhance response with confidence indicators and related topics"""
    enhanced = response
    
    # Add confidence indicator
    if confidence > 0.8:
        enhanced += "\n\n✅ **High Confidence Response** - This answer is very likely to be accurate and relevant to your question."
    elif confidence > 0.5:
        enhanced += "\n\n⚠️ **Medium Confidence Response** - This answer is based on related information. Please verify if this fully addresses your question."
    else:
        enhanced += "\n\n❓ **Low Confidence Response** - I'm not entirely sure about this answer. You might want to ask for clarification or try rephrasing your question."
    
    # Add related topics if confidence is low
    if confidence < 0.6:
